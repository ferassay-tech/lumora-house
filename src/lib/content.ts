...
},
{
  ...
  excerpt: "ترقبوا المزيد من إصدارات دار لومورا.",
  price: "",
  format: "",
  pages: "",
  language: "العربية",
...
export const faqs: { question: string; answer: string }[] = [
  ...
  },
  {
    ...
    answer:
      "نظرًا لأن منتجات دار لومورا رقمية ويتم تحميلها مباشرة بعد إتمام الشراء، فلا يمكن استرجاعها أو استبدالها بعد إتمام عملية الدفع، إلا في حال وجود مشكلة تقنية تمنع الوصول إلى المنتج. إذا واجهتِ أي مشكلة، يسعدنا مساعدتك عبر البريد الإلكتروني.",
  },
  {
